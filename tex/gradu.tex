...
\keywords{design science, recorded audio feedback, tool, audio-software, feedback form, heuristics, e-education environment}
\tiivistelma{%
Aänipalautteen hyödyntäminen opetuksessa on saavuttanut suosiota vuosien varrella, sillä se on tehokas palautemuoto tekstimuotoisen palautteen ohella. Äänipalaute on tekstimuotoista palauttetta yksityiskohtaisempaa, ymmärrettävempää ja henkilökohtaisempaa, joten. Äänipalautteen antaminen koostuu palautteen nauhoittamisesta ja sen jakamisesta, ja nämä toimenpiteet voidaan suorittaa usein eri tavoin. Tässä suunnittelutukimuksessa suunniteltiin ja toteutettiin äänipalautteen antamiseen suunnattu web-pohjainen työkalu, jota evaluoimalla selvitettiin, voidaanko äänipalautteen antamista helpottaa entisestään tai voidaanko suhtautumista sen antamiseen muuttaa. Työkalun suunnittelussa ja toteutuksessa hyödynnettiin Nielsenin heuristiikkoja sekä Gestaltin hahmolakeja, ja osa ratkaisuista päätettiin yhteistyössä äänipalautetta opetuksessaan hyödyntäneiden ohjaajien kanssa. Työkalun evaluointi suoritettiin kahdessa iteraatiossa, joista ensimmäiseen osallistuivat kaksi koehenkilöä. Ensimmäisen evaluoinnin pohjalta työkaluun tehtiin parannuksia, jonka jälkeen siirryttiin toiseen evaluointiin, jonka suorittivat neljä koehenkilöä. Tulosten perusteella voidaan sanoa, että...
}
\abstract{%
